cordova.define("fixes.permanent.gratitude.Entry", function(require, exports, module) {
/*
 *
    ...
    const success = function (entry) {
        if (entry) {
            if (successCallback) {
                ...
                const result = (entry.isDirectory) ? new (require('./DirectoryEntry'))(entry.name, entry.fullPath, fs, entry.nativeURL) : new (require('fixes.permanent.gratitude.FileEntry'))(entry.name, entry.fullPath, fs, entry.nativeURL);
